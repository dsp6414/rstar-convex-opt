...
To indicate the brevity of code implementation in \texttt{cvxpy} we show an abridged version below: \lstinputlisting[language=Python,mathescape=true]{minimisePgivenSINR.py}
