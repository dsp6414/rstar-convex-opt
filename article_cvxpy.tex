...
To indicate the brevity of code implementation in \texttt{cvxpy} we show an abridged version below: \lstinputlisting[language=Python]{minimisePgivenSINR.py}

\section{Outlook}
The authors hope that this article shows the ease with the which \texttt{cvxpy} can be brought to bare on simple ``toy'' problems of real world relevance. We believe that this is an invaluable resource for researchers wanting test the applicability of convex optimization in new fields. 
